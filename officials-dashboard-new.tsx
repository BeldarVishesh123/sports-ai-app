              ...
              {filteredAssessments.length > 0 ? (
                ...
                <Card className="p-8 text-center">
                  ...
                  <p className="text-gray-600">
                    Assessment data will appear here when users complete assessments in the SportAI application.
                  </p>
                </Card>
              )}
            </div>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    Performance Analytics & Regional Distribution
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <ProfessionalCharts />
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      {assessments.filter(a => a.status === 'verified').length === 0 && (
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {users.length > 0 ? (
                        ...
                        <div className="space-y-2">
                          ...
                          {user.bioData && (
                            <div className="text-xs text-gray-500">
                              <p>Age: {user.bioData.age} • {user.bioData.gender}</p>
                              <p>Blood: {user.bioData.bloodGroup}</p>
                            </div>
                          )}
                          <div className="pt-2 border-t">
                            <p className="text-sm">
                              <span className="text-gray-500">Avg Score:</span> 
                              <span className="font-medium ml-1">{user.averageScore}%</span>
                            </p>
                    ...
                    <div className="col-span-3 text-center py-8">
                      ...
                      <p className="text-gray-600">
                        User data will appear here when people sign up and use the SportAI application.
                      </p>
                    </div>
                  )}
                </div>
